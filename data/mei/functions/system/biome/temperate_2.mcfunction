...
execute if entity @p[tag=MEI_Calculating,predicate=mei:system/biome/temperate_2/mangrove_swamp] run data modify storage mei:storage actionbar.biome set value '["",{"translate":"biome.minecraft.mangrove_swamp","color":"green","bold":true}]'